...
void UI_ShowIntro(void)
{
    ...
    ssd1306_WriteString("Voltage Monitor", Font_7x10, White);
    ssd1306_SetCursor(0, 32);
    ssd1306_WriteString("Press button to", Font_7x10, White);
    ssd1306_SetCursor(0, 44);
    ssd1306_WriteString("show voltage.", Font_7x10, White);
...
{
    char buf[32];
    snprintf(buf, sizeof(buf), "Voltage: %lu.%02luV", vin_cV / 100, vin_cV % 100);
    ssd1306_Fill(Black);
    ssd1306_SetCursor(0, 0);
